...
while not salir:
    ...
    opcion = helpers.input_user_opcion()

    if opcion == 1:
        nombre = helpers.input_user_nombre()
        try:
        ...
        student_id = helpers.input_user_id()
        ...
        try:
            print("Media de la clase:", round(grades.media_clase(alumnos), 2))
        except Exception as e:
            print(f"Error: {e}")
